      ...
      <main>
        <section className="relative overflow-hidden border-b border-[#ded8ce] bg-[#f5f1ea] px-5 py-16 sm:px-8 sm:py-24 lg:px-10 lg:py-32">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.72fr] lg:items-end lg:gap-20">
            <div>
              <h1 className="max-w-4xl font-serif text-5xl leading-[0.98] tracking-[-0.04em] text-[#173047] sm:text-7xl lg:text-[6.25rem]">
                Built by investors, not developers watching from the outside.
              </h1>
              <p className="mt-7 max-w-2xl text-lg leading-8 text-[#61778d] sm:text-xl">
            ...
            <div className="border-l-2 border-[#3286c8] pl-7 sm:pl-10">
              <p className="font-serif text-[7rem] leading-none tracking-[-0.08em] text-[#3286c8] sm:text-[9rem]">15+</p>
              <p className="mt-3 max-w-xs text-lg leading-7 text-[#35516a]">
        ...
        <section className="border-b border-[#ded8ce] bg-[#fbfaf7] px-5 py-12 sm:px-8 lg:px-10 lg:py-16" aria-label="LandLinq track record">
          <div className="mx-auto grid max-w-7xl gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-0">
            {trackRecord.map(([value, label], index) => (
              <div
                key={label}
                className={`px-0 sm:px-6 lg:px-8 ${index > 0 ? "lg:border-l lg:border-[#ded8ce]" : ""}`}
              >
                <p className="font-serif text-4xl leading-none tracking-[-0.04em] text-[#173047] sm:text-5xl">{value}</p>
                <p className="mt-3 text-sm leading-6 text-[#61778d]">{label}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="px-5 py-20 sm:px-8 sm:py-28 lg:px-10 lg:py-36">
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24">
            <div>
              <p className="text-sm font-semibold text-[#3286c8]">The founding story</p>
              <h2 className="mt-5 max-w-md font-serif text-4xl leading-[1.02] tracking-[-0.04em] text-[#173047] sm:text-6xl">
                We&apos;re investors first, technologists second.
              </h2>
            </div>
            <div className="max-w-3xl border-t border-[#cfc7bb] pt-7 sm:pt-9">
              <p className="text-2xl leading-[1.35] tracking-[-0.02em] text-[#35516a] sm:text-4xl">
        ...
        <section id="founders" className="border-y border-[#ded8ce] bg-[#fbfaf7] px-5 py-16 sm:px-8 sm:py-24 lg:px-10">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-8 sm:grid-cols-2 sm:gap-12 lg:mt-14 lg:gap-20">
              <div className="border-t border-[#cfc7bb] pt-5">
                <p className="font-serif text-3xl tracking-[-0.03em] text-[#173047] sm:text-4xl">Jack Berg</p>
                <p className="mt-2 text-base text-[#61778d]">Co-Founder</p>
              </div>
              <div className="border-t border-[#cfc7bb] pt-5">
                <p className="font-serif text-3xl tracking-[-0.03em] text-[#173047] sm:text-4xl">AJ Klenk</p>
                <p className="mt-2 text-base text-[#61778d]">Co-Founder</p>
              </div>
            </div>
          </div>
        ...
        <section className="px-5 pb-16 sm:px-8 sm:pb-24 lg:px-10">
          <div className="mx-auto max-w-7xl rounded-[2rem] bg-[#173047] px-6 py-14 text-white sm:px-12 sm:py-20 lg:px-20">
            <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end lg:gap-16">
              <div>
                <h2 className="max-w-3xl font-serif text-4xl leading-[1.02] tracking-[-0.04em] sm:text-6xl">
              ...
              <a
                href="/contact"
                className="inline-flex min-h-12 items-center justify-center rounded-full border border-[#55c3e9] bg-[#55c3e9] px-6 text-sm font-semibold text-[#173047] transition-all hover:border-[#55c3e9] hover:bg-white hover:text-[#3286c8]"
              >
                Get in touch
              </a>
            </div>
