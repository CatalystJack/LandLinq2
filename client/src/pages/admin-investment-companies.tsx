...
export default function AdminInvestmentCompanies() {
  ...
  return <div className="min-h-screen bg-slate-50">
    ...
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><p className="text-sm font-semibold uppercase tracking-wider text-[#4A90E2]">Platform administration</p><h1 className="mt-1 text-3xl font-bold text-[#0A2B4A]">Investment Companies</h1><p className="mt-2 text-slate-600">Create company portals, configure acquisition criteria, and issue the first login.</p></div><Button onClick={openCreate} style={{ backgroundColor: "#0A2B4A" }}><Plus className="mr-2 h-4 w-4" />Create New Investment Company</Button></div>
