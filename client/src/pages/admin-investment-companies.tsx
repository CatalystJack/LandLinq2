...
function ManualEntryDialog({ company, open, onOpenChange }: { company: InvestmentCompany | null; open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  const isReview = !isIndustrial && (result?.classification?.toLowerCase() === "green" || result?.classification?.toLowerCase() === "review");
  const resultLabel = isIndustrial ? (isRed ? "Red" : "Yellow") : (isReview ? "Review" : "Passed");
