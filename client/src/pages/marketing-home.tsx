...
function ContactDetailMockup() {
  return (
    <div className="ll-app-frame ll-contact-detail">
      <div className="ll-detail-nav"><b><img src="/assets/landlinq-header-logo.png" alt="LandLinq" /></b><span>Deal Dashboard　 <i>CRM</i>　 Outreach Analytics　 Outreach Setup　 Data Hub　 Analytics</span><button>SIGN OUT</button></div>
