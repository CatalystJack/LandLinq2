    ...
    <div className="min-h-[100dvh] overflow-hidden bg-background text-foreground">
      <header className="absolute inset-x-0 top-0 z-30">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-10" aria-label="Main navigation">
          ...
          <div className="hidden items-center gap-8 md:flex"><Link href="/login" className="rounded-full border border-white bg-white px-4 py-2 text-sm font-semibold text-landlinq-blue hover:border-white hover:bg-white hover:text-landlinq-blue">Log In</Link></div>
