...
setTimeout(() => {
  (async () => {
    try {
      ...
      // Required idempotent intake migration. Run before route registration so
      // an unmigrated deployment fails startup rather than failing only after
      // the first automated outcome or analytics request.
