  ...
  async getDealById(id: string): Promise<Deal | undefined> {
    const [deal] = await db
      .select({
        ...
        schoolDistrict: deals.schoolDistrict,
        schoolDistrictFetchedAt: deals.schoolDistrictFetchedAt,
        nearbyPermitCount: deals.nearbyPermitCount,
        nearbyPermitsStatus: deals.nearbyPermitsStatus,
        nearbyPermitsFetchedAt: deals.nearbyPermitsFetchedAt,
